...
public class Main extends Application {
    ...
    private void caricaFogliStile(Scene scena) {
        try {
            scena.getStylesheets().add(getClass().getResource("/application/application.css").toExternalForm());
            scena.getStylesheets().add(getClass().getResource("/schermata/principali.css").toExternalForm());
